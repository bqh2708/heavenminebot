...
/**********************************************************  LEVEL EXE **********************************************************/
function levelExecute(args, message) {
    if (args[0]) {
        switch (args[0]) {
            case 'set':
        ...
        const avatar = message.member.user.displayAvatarURL !== 'https://discordapp.com/assets/6debd47ed13483642cf09e832ed0bc1b.png' ? Canvas.loadImage(message.member.user.displayAvatarURL)
            : Canvas.loadImage('./avatarDefault.jpg');
